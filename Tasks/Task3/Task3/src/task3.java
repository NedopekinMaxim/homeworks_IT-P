...
public class task3 {
    ...
    // 3. Если сумма коэф. числа = числу (совершенное число), то true
    ...
    public static String flipEndChars(String s) {
        ...
        // Создаем копию с типом StringBuilder, чтобы можно было пользоваться setCharAt
    ...
    public static boolean same(int[] arr1, int[] arr2) {
        ...
        int uniq1 = arr1.length; // кол-во уникальных эл-в 1-го массива
    ...
    // 7. Число Капрекара. Является ли. Если кол-во цифр нечетное, правая половинка больше левой.
    ...
    public static boolean rightTriangle(int x, int y, int z) {
        if (!(x + y > z) || !(x + z > y) || !(y + z > x))
            return false; // можно ли построить треугольник
        int[] edges = {x, y, z};
        Arrays.sort(edges);
